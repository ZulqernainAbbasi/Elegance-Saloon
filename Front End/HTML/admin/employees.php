                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>" . $row['employee_experience'] . "</td>
                                    <td>" . $row['employee_role'] . "</td>
                                    <td>" . $row['employee_email'] . "</td>
                                    <td>" . $row['employee_phoneNumber'] . "</td>
                                    <td>" . $row['employee_password'] . "</td>
                                    <td>" . $row['employee_rePassword'] . "</td>
                                    <td>
                                        <a href='employee_edit.php?id=" . $row['employee_id'] . "' class='btn btn-warning btn-sm'>Edit</a>
                                        <a href='delete.php?id=" . $row['employee_id'] . "&type=employee' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete?\")'>Delete</a>
                                    </td>
                                  </tr>";
                        }
                    } else {
